...
extern i2c_master_dev_handle_t i2c_lv53l0x_handle;
...
void VL53L0X::writeReg(uint8_t reg, uint8_t value)
{
    ...
    i2c_master_transmit(i2c_lv53l0x_handle, data, 2, 100);
    last_status = 0;
}
...
void VL53L0X::writeReg16Bit(uint8_t reg, uint16_t value)
{
    ...
    i2c_master_transmit(i2c_lv53l0x_handle, data, 3, 100);
    last_status = 0;
}
...
void VL53L0X::writeReg32Bit(uint8_t reg, uint32_t value)
{
    ...
    i2c_master_transmit(i2c_lv53l0x_handle, data, 5, 100);
    last_status = 0;
}
...
uint8_t VL53L0X::readReg(uint8_t reg)
{
    ...
    i2c_master_transmit(i2c_lv53l0x_handle, &reg, 1, 100);
    last_status = 0;
    uint8_t value[1];
    // i2c.read(address, value, 1);
    i2c_master_receive(i2c_lv53l0x_handle, value, 1, 1000);
...
uint16_t VL53L0X::readReg16Bit(uint8_t reg)
{
    ...
    i2c_master_receive(i2c_lv53l0x_handle, value, 2, 1000);
...
uint32_t VL53L0X::readReg32Bit(uint8_t reg)
{
    ...
    i2c_master_receive(i2c_lv53l0x_handle, value, 3, 1000);
...
void VL53L0X::writeMulti(uint8_t reg, uint8_t const *src, uint8_t count)
{
    ...
    i2c_master_transmit(i2c_lv53l0x_handle, data, count + 1, 100);
    last_status = 0;
}
...
void VL53L0X::readMulti(uint8_t reg, uint8_t *dst, uint8_t count)
{
    ...
    i2c_master_receive(i2c_lv53l0x_handle, dst, count, 1000);
}
// --------------------
